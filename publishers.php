...
<section class="publishers">
   ...
   <h1 class="heading">expert publishers</h1>

   <form action="search_publ.php" method="post" class="search-publ">
   ...
   <div class="box-container">
      ...
      <?php
         $select_publ = $conn->prepare("SELECT * FROM `publisher`");
         $select_publ->execute();
      ...
      <?php
            ...
            echo '<p class="empty">no publishers found!</p>';
         }
      ?>
