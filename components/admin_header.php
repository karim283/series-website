...
<header class="header">
   ...
   <section class="flex">
      ...
      <div class="profile">
         <?php
            $select_profile = $conn->prepare("SELECT * FROM `publisher` WHERE id = ?");
            $select_profile->execute([$publ_id]);
...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="contents.php"><i class="fa-solid fa-film"></i><span>contents</span></a>
