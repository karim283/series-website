...
<section class="series">
   ...
   <div class="box-container">
      ...
      <?php
         if(isset($_POST['search_series']) or isset($_POST['search_series_btn'])){
         $search_series = $_POST['search_series'];
         $select_seriess = $conn->prepare("SELECT * FROM `playlist` WHERE title LIKE '%{$search_series}%' AND status = ?");
