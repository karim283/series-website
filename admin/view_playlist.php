...
<section class="playlist-details">
   ...
   <?php
      $select_playlist = $conn->prepare("SELECT * FROM `playlist` WHERE id = ? AND publisher_id = ?");
      $select_playlist->execute([$get_id, $publ_id]);
...
<section class="contents">
   ...
   <?php
      $select_videos = $conn->prepare("SELECT * FROM `content` WHERE publisher_id = ? AND playlist_id = ?");
      $select_videos->execute([$publ_id, $playlist_id]);
