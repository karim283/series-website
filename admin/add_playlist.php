...
if(isset($_POST['submit'])){
   ...
   $add_playlist = $conn->prepare("INSERT INTO `playlist`(id, publisher_id, title, description, thumb, status) VALUES(?,?,?,?,?,?)");
   $add_playlist->execute([$id, $publ_id, $title, $description, $rename, $status]);
